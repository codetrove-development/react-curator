(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SnappyGridReact"] = factory();
	else
		root["SnappyGridReact"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/SnappyGrid.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SnappyGrid; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _SnappyGridItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SnappyGridItem */ "./src/SnappyGridItem.js");
/* harmony import */ var snappy_grid_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! snappy-grid-core */ "./node_modules/snappy-grid-core/dist/snappy-grid-core.min.js");
/* harmony import */ var snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(snappy_grid_core__WEBPACK_IMPORTED_MODULE_2__);
...
// todo move back but need to install npm package in examples


 // todo for perf test: change items to an array

var defaultProps = {
  gridOptions: snappy_grid_core__WEBPACK_IMPORTED_MODULE_2__["defaultGridOptions"]
};
...
function (_React$Component) {
  _inherits(SnappyGrid, _React$Component);
  ...
  function SnappyGrid() {
    ...
    _classCallCheck(this, SnappyGrid);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SnappyGrid).call(this, props));
    ...
    _this.gridOptions = _objectSpread({}, snappy_grid_core__WEBPACK_IMPORTED_MODULE_2__["defaultGridOptions"], _this.props.gridOptions);
    _this.grid = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.getEmptyGrid(_this.gridOptions.gridRows);
  ...
  _createClass(SnappyGrid, [{
    key: "getDefaultItemProps",
    value: function getDefaultItemProps() {
      return _objectSpread({}, snappy_grid_core__WEBPACK_IMPORTED_MODULE_2__["defaultItemOptions"], {
    ...
    value: function renderGridItem(index, child) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_SnappyGridItem__WEBPACK_IMPORTED_MODULE_1__["default"], _extends({
        key: child.id
    ...
    value: function removeMissingChildren() {
      ...
      this.gridItems.forEach(function (item) {
        ...
        if (!props) {
          var removeResult = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.removeGridItem(_this3.gridItems, _this3.grid, item, gridOptions, _this3.gridSizing);
      ...
      this.gridItems.forEach(function (item) {
        ...
        if (_this3.itemPositionChanged(item, itemProps)) {
          ...
          var movementResult = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.onItemPositionChanged(itemProps, item, options);
    ...
    value: function generateGridItemProps(child) {
      ...
      var classes = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.getItemClasses(child.props);
      var position = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.getItemPosition(gridSizing.widthPx, gridSizing.heightPx, gridRows, gridColumns, width, height, x, y, renderMode);
      var meta = {
        isDragging: false,
        pseudo: false,
        isConfigured: false
      ...
      var itemProps = _objectSpread({
        id: child.key
      }, snappy_grid_core__WEBPACK_IMPORTED_MODULE_2__["defaultItemOptions"], child.props, {
        classes: classes,
        position: position,
        meta: meta
      });

      var defaultStyles = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.getItemStyles(child.props);
      var positionStyles = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.getItemPositionStyles(this.gridOptions, itemProps.styles, position);
      ...
      var addResult = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.addItemToGrid(allItemProps, options);
    ...
    value: function syncGridProps() {
      this.gridOptions = _objectSpread({}, this.gridOptions, this.props.gridOptions); // optional override by props - allows resize handling
    ...
    value: function onItemDragStart(itemProps) {
      var _SnappyCore$onItemDra = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.onItemDragStart(itemProps),
          item = _SnappyCore$onItemDra.item,
          success = _SnappyCore$onItemDra.success;
    ...
    value: function onItemDragged(itemProps, movementDetails) {
      ...
      var dragResult = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.onItemDrag(itemProps, options, movementDetails);
    ...
    value: function updateItemPositions() {
      ...
      this.gridItems = this.gridItems.map(function (item) {
        var width = item.width,
            ...
            x = item.x,
            y = item.y;
        var position = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.getItemPosition(widthPx, heightPx, gridRows, gridColumns, width, height, x, y, renderMode);
        var positionStyles = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.getItemPositionStyles(_this5.gridOptions, item.styles, position);
    ...
    value: function onItemDragStop(itemProps) {
      ...
      var updatedItem = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.onItemDragStop(itemProps, items, widthPx, heightPx, this.gridOptions, gridSizing);
    ...
    value: function onItemResizeStart(itemProps) {
      var _SnappyCore$onItemRes = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.onItemResizeStart(itemProps),
          item = _SnappyCore$onItemRes.item,
          success = _SnappyCore$onItemRes.success;
    ...
    value: function onItemResize(itemProps, movementDetails) {
      ...
      var resizeResult = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.onItemResize(itemProps, options, movementDetails);
    ...
    value: function onItemResizeStop(itemProps) {
      ...
      var items = this.gridItems;
      var updatedItem = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.onItemResizeStop(itemProps, items, widthPx, heightPx, this.gridOptions, gridSizing);
      this.updateGridItems([updatedItem]);
      this.onItemsChange([updatedItem]);
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SnapperGridItem; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(SnapperGridItem, _React$Component);

  function SnapperGridItem(props) {
    var _this;

    _classCallCheck(this, SnapperGridItem);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SnapperGridItem).call(this, props)); // for getting element position & sizing
  ...
  _createClass(SnapperGridItem, [{
    ...
    value: function onDrag(e, data) {
      ...
      var styles = snappy_grid_core__WEBPACK_IMPORTED_MODULE_2___default.a.getItemPositionStyles(this.props.gridOptions, this.props.styles, position);
      this.setState({
        styles: styles
...
//# sourceMappingURL=snappy-grid-react.js.map